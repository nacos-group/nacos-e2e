...
public class MultiTenantInstanceAPITest extends NamingBase{
    ...
    public void testMultipleTenant_listInstance() throws Exception {
        ...
        JSONObject json = JSON.parseObject((String) httpResult.content);
        ...
        httpResult = request(this.base.toString() + "/nacos/v1/ns/instance/list", Collections.<String>emptyList(),
                ...
                HttpMethod.GET);
        Assertions.assertEquals(HttpURLConnection.HTTP_OK, httpResult.code);
        json = JSON.parseObject((String) httpResult.content);
    ...
    public void testMultipleTenant_updateInstance() throws Exception {
        ...
        httpResult = request(this.base.toString() + "/nacos/v1/ns/instance/list", Collections.<String>emptyList(),
            ...
            HttpMethod.GET);
        Assertions.assertEquals(HttpURLConnection.HTTP_OK, httpResult.code);
        Assertions.assertEquals(1, JSON.parseObject((String) httpResult.content).getJSONArray("hosts").size());
