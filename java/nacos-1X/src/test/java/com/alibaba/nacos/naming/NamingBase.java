...
public class NamingBase extends BaseOperate {
    ...
    public HttpRestResult deleteService(String serviceName, String namespace) throws Exception {
        return deleteService(serviceName, namespace, Constants.DEFAULT_GROUP);
    }
    public HttpRestResult deleteService(String serviceName, String namespace, String groupName) throws Exception {
        //删除service
    ...
    public void namingServiceCreate(String serviceName, String namespace,
        ...
        HttpRestResult httpResult = request(base.toString() + "/nacos/v1/ns/service",
            Collections.<String>emptyList(),
            ParamsUtils.newParams()
                .appendParam("serviceName", serviceName)
    ...
    public void instanceRegister(String serviceName, String namespace, String groupName,
        ...
        HttpRestResult httpResult = request(base.toString() + "/nacos/v1/ns/instance", Collections.<String>emptyList(),
